  ...
  return (
    <SafeAreaView style={[s.root, { backgroundColor: colors.background }]}>
      ...
      <View style={s.empty}>
        ...
        <Text style={[s.emptyTitle, { color: colors.text }]}>Free matric resources</Text>
        <Text style={[s.emptyText, { color: colors.textSecondary }]}>DBE past papers for Grades 10–12 coming soon</Text>
      </View>
    </SafeAreaView>
  );
}
