  ...
  return (
    <SafeAreaView style={[s.root, { backgroundColor: colors.background }]}>
      ...
      <View style={s.empty}>
        ...
        <Text style={[s.emptyTitle, { color: colors.text, fontSize: fonts.xl }]}>Nothing here yet</Text>
        <Text style={[s.emptyText, { color: colors.textSecondary, fontSize: fonts.sm }]}>Community posts and alerts will appear here</Text>
      </View>
    </SafeAreaView>
  );
}
